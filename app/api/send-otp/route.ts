  ...
  try {
    ...
    try {
      ...
      if (process.env.NODE_ENV === "development") {
        ...
        console.log(
          `Development mode: OTP generated for User ID: ${studentId}, OTP: ${otp}`
        );
        ...
        try {
          ...
          console.log(
            `OTP sent successfully via Twilio Verify. Status: ${verification.status}, SID: ${verification.sid}, User ID: ${studentId}`
          );
